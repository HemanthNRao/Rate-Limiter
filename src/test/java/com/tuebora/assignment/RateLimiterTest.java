...
public class RateLimiterTest
{
     ...
     * rate limiter will accept if number of requests is less than allowed rate.
    ...
    /**
     * Testcase: Unit test to check
     * rate limiter will throw exception if number of requests is more than allowed rate.
